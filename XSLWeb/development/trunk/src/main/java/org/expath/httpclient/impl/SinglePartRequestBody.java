...
public class SinglePartRequestBody extends HttpRequestBody {
  ...
  //
  public SinglePartRequestBody(Element elem, Sequence bodies, Type method) throws HttpClientException {
    super(elem);
    myMethod = method;
    String[] attr_names = { 
        "src", 
    ...
    // ...
    {
      ...
      String[] NOT_SUPPORTED_ATTRS = { "byte-order-mark", "cdata-section-elements", "doctype-public", "doctype-system", "escape-uri-attributes", "normalization-form", "standalone", "suppress-indentation", "undeclare-prefixes", "output-version" };
  ...
  public void setHeaders(HeaderSet headers) throws HttpClientException {
    ...
    if (headers.getFirstHeader("Content-Type") == null) {
      ...
      if (myMethod == Type.XML || myMethod == Type.HTML || myMethod == Type.XHTML || myMethod == Type.TEXT) {
  ...
  public Properties getSerializationParams() throws HttpClientException {
