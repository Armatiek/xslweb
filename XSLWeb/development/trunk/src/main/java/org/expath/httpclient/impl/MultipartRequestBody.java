...
public class MultipartRequestBody extends HttpRequestBody {
  ...
  public MultipartRequestBody(Element elem, Sequence bodies) throws HttpClientException {
    super(elem);
    // set up boundary
  ...
  private void accumulateBodies(Element elem, Sequence bodies) throws HttpClientException {
    ...
    // iterate over child elements in http: namespace (ignore other qualified
    // elements)
