...
public class MultipartResponseBody implements HttpResponseBody {
  ...
  public MultipartResponseBody(Result result, InputStream in, ContentType type, 
      HttpConnection conn) throws HttpClientException {
    myContentType = type;
  ...
  private void analyzeParts(Result result, InputStream in, String type) throws IOException, HttpClientException {
  ...
  private String parseFieldBody(Field f) throws HttpClientException {
    try {
