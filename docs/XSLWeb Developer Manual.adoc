...
:window-blank: _blank
:xslweb-version: 4.0.0-RC1
:xslweb-version-download: 4-0-0-RC1 
:saxon-version: 9.9.1-7
:saxon-version-download: 9-9-1-7J 
...
* https://github.com/Armatiek/xslweb/releases/download/v{xslweb-version}/xslweb-ready-to-run-v{xslweb-version}-linux-x64.tar.gz (for Linux 64-bits machines)
* https://github.com/Armatiek/xslweb/releases/download/v{xslweb-version}/xslweb-ready-to-run-v{xslweb-version}-osx-x64.tar.gz (for macOS 64-bits machines)
* https://github.com/Armatiek/xslweb/releases/download/v{xslweb-version}/xslweb-ready-to-run-v{xslweb-version}-windows-x64.zip (for Windows 64-bits machines)
...
* https://github.com/Armatiek/xslweb/releases/download/v{xslweb-version}/xslweb-war-v{xslweb-version}.tar.gz (Linux/macOS)
* https://github.com/Armatiek/xslweb/releases/download/v{xslweb-version}/xslweb-war-v{xslweb-version}.zip (Windows)
...
** PE:
*** mvn install:install-file -Dfile=saxon9pe.jar -DgroupId=net.sf.saxon -DartifactId=Saxon-PE -Dversion={saxon-version} -Dpackaging=jar
*** mvn install:install-file -Dfile=saxon9-icu.jar -DgroupId=net.sf.saxon -DartifactId=Saxon-PE-icu -Dversion={saxon-version} -Dpackaging=jar
*** mvn install:install-file -Dfile=saxon9-sql.jar -DgroupId=net.sf.saxon -DartifactId=Saxon-PE-sql -Dversion={saxon-version} -Dpackaging=jar
** EE:
*** mvn install:install-file -Dfile=saxon9ee.jar -DgroupId=net.sf.saxon -DartifactId=Saxon-EE -Dversion={saxon-version} -Dpackaging=jar
*** mvn install:install-file -Dfile=saxon9-icu.jar -DgroupId=net.sf.saxon -DartifactId=Saxon-EE-icu -Dversion={saxon-version} -Dpackaging=jar
*** mvn install:install-file -Dfile=saxon9-sql.jar -DgroupId=net.sf.saxon -DartifactId=Saxon-EE-sql -Dversion={saxon-version} -Dpackaging=jar
