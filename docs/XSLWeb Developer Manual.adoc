...
XSLWeb uses the https://docs.oracle.com/javase/10/nashorn/introduction.htm#JSNUG136[Java Nashorn scripting engine,window={window-blank}] to execute the Javascript code.
...
IMPORTANT: With the release of Java 11, Nashorn is deprecated, and has been removed from JDK 15 onwards, but https://github.com/openjdk/nashorn[OpenJDK Nashorn,window={window-blank}] supports Java starting with version 15.3.
