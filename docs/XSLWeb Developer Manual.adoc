...
* https://github.com/Armatiek/xslweb/releases/download/v{xslweb-version}/xslweb-v{xslweb-version}-linux-x64.tar.gz (for Linux 64-bits machines)
* https://github.com/Armatiek/xslweb/releases/download/v{xslweb-version}/xslweb-v{xslweb-version}-osx-x64.tar.gz (for macOS 64-bits machines)
* https://github.com/Armatiek/xslweb/releases/download/v{xslweb-version}/xslweb-v{xslweb-version}-windows-x64.zip (for Windows 64-bits machines)
