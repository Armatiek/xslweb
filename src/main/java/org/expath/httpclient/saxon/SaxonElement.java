...
public class SaxonElement implements Element {
  ...
  private static class AttributeIterable implements Iterable<Attribute> {
  ...
  private static class AttributeIteratorWrapper implements Iterator<Attribute> {
  ...
  private class ElemIterable implements Iterable<Element> {
  ...
  private class ElemIteratorWrapper implements Iterator<Element> {
