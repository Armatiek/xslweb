...
public class RequestParser {
  ...
  public HttpRequest parse(Element request, Sequence bodies, String href) throws HttpClientException {
    if (!"request".equals(request.getLocalName()) || !HttpConstants.HTTP_CLIENT_NS_URI.equals(request.getNamespaceUri())) {
