...
public class BodyFactory {
  ...
  public static HttpRequestBody makeRequestBody(Element elem, Sequence bodies) throws HttpClientException {
  ...
  public static enum Type {
    XML, HTML, XHTML, TEXT, BINARY, BASE64, HEX, MULTIPART, SRC
  }
   ...
   */
  public static Type parseType(ContentType type) throws HttpClientException {
    if (type == null) {
      throw new HttpClientException("impossible to find the content type");
    }
    String t = type.getType();
