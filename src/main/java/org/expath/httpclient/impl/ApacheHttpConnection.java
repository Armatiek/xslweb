...
/**
  ...
  */
   ...
   * 
   * Configurable by the system property {@code org.expath.hc.http.version}. By
   * default, use HTTP 1.1. Can be set on a per-request basis, by setting the
   * {@code http:request/@http} attribute.
   */
  ...
  /**
   * A request entity producer, generating content from an
   * {@link HttpRequestBody}.
   */
  private static class RequestBodyProducer implements ContentProducer {
