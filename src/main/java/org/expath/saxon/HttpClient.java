...
public class HttpClient {
   ...
   * </pre>
   */
  public static SequenceIterator sendRequest(XPathContext ctxt, NodeInfo request) throws XPathException {
    return sendRequest(ctxt, request, null, null, null);
  }
   ...
   * </pre>
   */
  public static SequenceIterator sendRequest(XPathContext ctxt, NodeInfo request, String href) throws XPathException {
    return sendRequest(ctxt, request, href, null, null);
  }
  ...
  private SequenceIterator doSendRequest(XPathContext ctxt, NodeInfo request, String href, SequenceIterator bodies, CloseableHttpClient httpClient) throws HttpClientException, XPathException {
    ...
    try {
      ...
      SaxonResult result = sendOnce(uri, req, parser, ctxt, httpClient);
  ...
  private SaxonResult sendOnce(URI uri, HttpRequest request, RequestParser parser, XPathContext ctxt, CloseableHttpClient httpClient) throws HttpClientException {
    ...
    try {
      if (parser.getSendAuth()) {
        ...
        HttpResponse response = request.send(result, conn, null, httpClient);
