...
public interface IWebdavStore {
  ...
  /**
   * Life cycle method, called by WebdavServlet's destroy() method. Should be
   ...
   * been started. The request will be terminated by either {@link #commit()} or
   * {@link #rollback()}. If only non-read methods have been called, the request
   * will be terminated by a {@link #commit()}. This method will be called by
   * (@link WebdavStoreAdapter} at the beginning of each request.
   * 
   * 
   * @param principal
  ...
  /**
   * Indicates that all changes done inside this request shall be made permanent
   * and any transactions, connections and other temporary resources shall be
   * terminated.
   * 
   * @param transaction
   *          indicates that the method is within the scope of a WebDAV
  ...
  /**
   * Indicates that all changes done inside this request shall be undone and any
   * transactions, connections and other temporary resources shall be
   * terminated.
   * 
   * @param transaction
   *          indicates that the method is within the scope of a WebDAV
