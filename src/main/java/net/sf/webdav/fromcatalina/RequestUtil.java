...
public final class RequestUtil {
   ...
   * and so on ) it it. <strong>WARNING</strong> - This method is useful only
   * for normalizing application-generated paths. It does not try to perform
   ...
   * entire query string ahead of time, to properly deal with the case where the
   * name or value includes an encoded "=" or "&" character that would otherwise
   * be interpreted as a delimiter.
   * 
   * @param map
   ...
   * converted to a string, the system default character encoding is used...
   * This may be different than some other servers.
   * 
   * @param str
   ...
   * entire query string ahead of time, to properly deal with the case where the
   * name or value includes an encoded "=" or "&" character that would otherwise
   * be interpreted as a delimiter. NOTE: byte array data is modified by this
