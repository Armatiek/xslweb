...
public abstract class XMLCommand implements Comparable<Object> {
  ...
  public int compareTo(Object o) {
    ...
    while ((me.hasMoreTokens()) && (obj.hasMoreTokens())) {
      ...
      if (meVal != objVal) {
        // System.out.println("found predecessor path so " + meVal + "-" +
        // objVal);
    ...
    if (result == 0) {
      if (me.hasMoreTokens()) {
        ...
        // System.out.println("same paths so use positions : " + cmd.pos + "-" +
        // this.pos);
