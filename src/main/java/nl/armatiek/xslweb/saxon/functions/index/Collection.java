...
public class Collection extends ExtensionFunctionDefinition {
  ...
  private static final StructuredQName qName = 
      new StructuredQName("", Definitions.NAMESPACEURI_XSLWEB_FX_XMLINDEX, "collection");
  ...
  public SequenceType[] getArgumentTypes() {
    return new SequenceType[] { SequenceType.makeSequenceType(new JavaExternalObjectType(Session.class), StaticProperty.ALLOWS_ONE) };
  }
  ...
  private static class CollectionCall extends ExtensionFunctionCall {
    ...
    public Sequence call(XPathContext context, Sequence[] arguments) throws XPathException {            
      ...
      return SequenceTool.toLazySequence(session.getAllDocuments());
    }
  }
