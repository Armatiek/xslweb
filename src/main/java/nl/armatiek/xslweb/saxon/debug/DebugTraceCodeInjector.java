...
/**
 * A code injector that wraps every expression (other than a literal) in a
 * TraceExpression, which causes a TraceListener to be notified when the
 * expression is evaluated
 */
public class DebugTraceCodeInjector extends TraceCodeInjector {
