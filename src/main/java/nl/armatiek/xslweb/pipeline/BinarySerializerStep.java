...
import nl.armatiek.xslweb.serializer.BinarySerializer;

public class BinarySerializerStep extends SerializerStep {
  
  public BinarySerializerStep(Attributes atts) {
    super(atts);            
  }
  ...
  public Destination getDestination(WebApp webApp, HttpServletRequest req, HttpServletResponse resp, 
    ...
    return new SAXDestination(new BinarySerializer(webApp, req, resp, os));            
  }
