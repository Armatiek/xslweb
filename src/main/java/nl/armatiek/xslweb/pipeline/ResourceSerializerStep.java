...
import nl.armatiek.xslweb.serializer.ResourceSerializer;

public class ResourceSerializerStep extends SerializerStep {
  
  public ResourceSerializerStep(Attributes atts) {
    super(atts);            
  }
  ...
  public Destination getDestination(WebApp webApp, HttpServletRequest req, HttpServletResponse resp, 
    ...
    return new SAXDestination(new ResourceSerializer(webApp, req, resp, os));            
  }
