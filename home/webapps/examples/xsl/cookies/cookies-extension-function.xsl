...
<xsl:stylesheet 
  ...
  <xsl:template name="title" as="xs:string">Cookies example using extension function</xsl:template>
  ...
  <xsl:template name="tab-contents-1">
    ...
    127.0.0.1 localhost.com<br/><br/>
      to your local hosts file and access this page using that domain or click on <a href="{concat('http://localhost.com:', /*/req:local-port, /*/req:context-path, '/examples/cookies-extension-function.html')}">this</a> link.
    </p>
